...
## Group Collaboration
Throughout the project, our team will use GitHub to create a shared repository for all team members to contribute as well as peer review and edit each others' work. To create our ERD, we will use LucidChart to set up the database structure and how different data tables will tie together. Finally, we will use Google Jamboard to document tasks needed to accomplish for each segment. See image below for First Segment Jamboard page.
